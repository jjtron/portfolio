...
function DropdownList() { 
    ...
    return (
        <div className="relative" onMouseOver={() => {setShowDropdown(true)}} onMouseLeave={() => {setShowDropdown(false)}}>
            ...
            <div className={clsx("flex flex-col absolute top-4 md:top-6 left-2 bg-18181b w-[110px] extra-small-font md:text-base rounded-b-md", { 'visible' : showDropdown, 'hidden' : !showDropdown })}>
